<?php
 ...
 // НЕ НАХОДИТ ФОРМЫ С GET МЕТОДОМ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

 // Выполняем поиск по базе данных
 $sql = "SELECT * FROM `airports/airlines` WHERE Airline LIKE '%$SearchRoute%' OR country LIKE '%$SearchCountry%' OR arrival_date LIKE '%$SearchArrival_date%' OR departure_date LIKE '%$SearchDeparture_date%'";
